"""
Django settings for aged_fog_42352 project.
...
ROOT_URLCONF = 'aged_fog_42352.urls'
...
WSGI_APPLICATION = 'aged_fog_42352.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_fog_42352 API",
    "DESCRIPTION": "API documentation for aged_fog_42352 App",
    "VERSION": "v1",
}
